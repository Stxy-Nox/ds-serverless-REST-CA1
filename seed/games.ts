...
export const games: Game[] = [
  ...
  },
  {
    ...
    summary: "Step into the Dark... As Carrington Institute's most promising new Agent, Joanna Dark must uncover the truth behind the dataDyne Corporation's recent technological breakthroughs - breakthroughs which could have serious consequences for mankind.",
    meta_score: 97,
    user_review: 8.8,
    isEighthGen: false
  },
  ...
  },
  {
    ...
    summary: 'Players are put at the heart of their very own gangster movie, and let loose in a fully-realised 3 dimensional city with a cast of hundreds, 50 plus vehicles, ranging from sports cars to ice cream trucks and from boats to buses, 3 hours of music, including opera, reggae, house, drum and bass, pop and disco, and a huge array of street ready weapons. [Rockstar Games]',
    meta_score: 97,
    user_review: 8.4,
    isEighthGen: false
  },
  ...
  //   name: 'Half-Life 2',
  //   platform: 'PC',
  //   release_date: '16-Nov-04',
  //   summary: "[Metacritic's 2004 PC Game of the Year] By taking the suspense, challenge and visceral charge of the original, and adding startling new realism and responsiveness, Half-Life 2 opens the door to a world where the player's presence affects everything around him, from the physical environment to the behaviors -- even the emotions -- of both friends and enemies. The player again picks up the crowbar of research scientist Gordon Freeman, who finds himself on an alien-infested Earth being picked to the bone, its resources depleted, its populace dwindling. Freeman is thrust into the unenviable role of rescuing the world from the wrong he unleashed back at Black Mesa. And a lot of people -- people he cares about -- are counting on him. [Vivendi Universal]",
  //   meta_score: 96,
  //   user_review: 9.2,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'Wii U',
  //   release_date: '3-Mar-17',
  //   summary: "Ignore everything you know about The Legend of Zelda games. Step into a world of discovery, exploration and adventure in The Legend of Zelda: Breath of the Wild. Travel across fields, through forests and to mountain peaks as you discover what has become of the ruined kingdom of Hyrule in this stunning open-air adventure. Explore the wilds of Hyrule any way you like - Climb up towers and mountain peaks in search of new destinations, then set your own path to get there and plunge into the wilderness. Along the way, you'll battle towering enemies, hunt wild beasts and gather ingredients for the food and elixirs you'll need to sustain you on your journey. More than 100 Shrines of Trials to discover and explore - Shrines dot the landscape, waiting to be discovered in any order you want. Search for them in various ways, and solve a variety of puzzles inside. Work your way through the traps and devices inside to earn special items and other rewards that will help you on your adventure. Be prepared and properly equipped - With an entire world waiting to be explored, you'll need a variety of outfits and gear to reach every corner. You may need to bundle up with warmer clothes or change into something better suited to the desert heat. Some clothing even has special effects that, for example, can make you faster and stealthier. [Nintendo]",
  //   meta_score: 96,
  //   user_review: 8.3,
  //   isEighthGen: true
  // },
  ...
  //   platform: 'PlayStation 3',
  //   release_date: '13-Oct-09',
  //   summary: 'Fortune hunter Nathan Drake returns in Uncharted 2: Among Thieves, a third-person action-adventure/shooter created by award-winning developer Naughty Dog. Down on his luck, Drake is lured back into the treacherous world of thieves and mercenary treasure-seekers he had sought to leave behind. When a mysterious artifact propels Drake on an expedition to find the legendary Himalayan valley of Shambhala, he finds himself embroiled in a dangerous game of cat-and-mouse against a fugitive war criminal who?\x80?s after more than just the fabled riches of the lost city. Caught in a web of deception and plunged into an increasingly deadly pursuit that tests the limits of his endurance, Drake will be forced to risk everything - but has his luck finally run out? [SCEA]',
  //   meta_score: 96,
  //   user_review: 8.8,
  //   isEighthGen: false
  // },
  ...
  //   name: 'Mass Effect 2',
  //   platform: 'Xbox 360',
  //   release_date: '26-Jan-10',
  //   summary: 'The Mass Effect trilogy is a science fiction adventure set in a vast universe filled with dangerous alien life forms and mysterious uncharted planets. In this dark second chapter, Saren?\x80?s evil army of Geth soldiers has just been defeated, and humans, who are still struggling to make their mark on the galactic stage, are now faced with an even greater peril. [BioWare]',
  //   meta_score: 96,
  //   user_review: 8.9,
  //   isEighthGen: false
  // },
  ...
  //   name: 'Gran Turismo',
  //   platform: 'PlayStation',
  //   release_date: '30-Apr-98',
  //   summary: 'Welcome to the most advanced racing game ever created! Encounter exhilarating high-speed racing in 11 stunning environments. Feel handling agility and throttle response so convincing, the car seems to be an extension of yourself. Experience the extraordinary world of Gran Turismo!',
  //   meta_score: 96,
  //   user_review: 8.6,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'Xbox',
  //   release_date: '31-Oct-03',
  //   summary: "From the dark and seedy streets of Liberty City's underworld to the glamorous hedonism of Vice City of the 1980s, the Grand Theft Auto double-pack takes you through the huge worlds of Grand Theft Auto III and it's sequel Vice City. The highly controversial Grand Theft Auto III gives you the freedom to go anywhere and jack anyone, putting the dark, intriguing and ruthless world of crime at your fingertips. Vice City is an entirely new game set in the '80s, preserving and adding to the free-roaming gameplay, cinematic graphics and immersive audio experience that made the Grand Theft Auto III so popular.",
  //   meta_score: 96,
  //   user_review: 8.1,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PlayStation 3',
  //   release_date: '27-Oct-08',
  //   summary: "In LittleBigPlanet Players meet on a blue and green planet scattered with individual plots ?\x80? and use their character's amazing abilities to play, create and share what they build with other gamers throughout the world via the Playstation Network. The LittleBigPlanet experience starts with players learning about their character?\x80?s powers to interact physically with the environment. There are places to explore, creative resources to collect and puzzles to solve ?\x80? all requiring a combination of brains and collaborative teamwork. As soon as players begin their creative skills will grow and they will soon be ready to start creating and modifying their surroundings ?\x80? the first step to sharing them with the whole community.Characters have the power to move anything in this glued and stitched-together 3D landscape; they have the power to design, shape and build both objects and entire locations for others to view and play. There?\x80?s no complicated level editor; all of these skills can be learned by simply playing the game. Creativity is part of the gameplay experience and playing is part of the creative experience. Players can make their world as open or as secretive to explore as they like. When it?\x80?s ready, they can invite anyone within the LittleBigPlanet community to come and explore their patch ?\x80? or can go and explore everybody else's. [SCEA]",
  //   meta_score: 95,
  //   user_review: 6.8,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'GameCube',
  //   release_date: '17-Nov-03',
  //   summary: "Receive Four Complete Classic Zelda games all on one disc when you buy the Zelda GameCube Bundle: The Legend of Zelda, Zelda II - The adventure of Link, The Legend of Zelda: Ocarina of Time, The Legend of Zelda: Majora's Mask. The disc also includes: Playable Demo of the Legend of Zelda: The Wind Waker, Zelda Retrospective Movie, The Legend of Zelda: The Wind Waker Movie Preview.",
  //   meta_score: 95,
  //   user_review: 8.9,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PlayStation 3',
  //   release_date: '18-May-10',
  //   summary: "Developed by Rockstar San Diego, as a follow up to the 2004 hit game Red Dead Revolver, Red Dead Redemption is a Western epic, set at the turn of the 20th century when the lawless and chaotic badlands began to give way to the expanding reach of government and the spread of the Industrial Age. The story of former outlaw, John Marston, Red Dead Redemption takes players on a great adventure across the American frontier. Utilizing Rockstar's proprietary Rockstar Advanced Game Engine (RAGE), Red Dead Redemption features an open-world environment for players to explore, including frontier towns, rolling prairies teeming with wildlife, and perilous mountain passes - each packed with an endless flow of varied distractions. Along the way, players experience the heat of gunfights and battles, meet a host of unique characters, struggle against the harshness of one of the world?\x80?s last remaining wildernesses, and ultimately pick their own precarious path through an epic story about the death of the Wild West and the gunslingers that inhabited it. [Rockstar Games]",
  //   meta_score: 95,
  //   user_review: 8.9,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PlayStation 2',
  //   release_date: '9-Jul-01',
  //   summary: 'With the addition of two new courses (a downtown Tokyo circuit and the Monte Carlo Grand Prix course), an impressive range of cars (from Vipers to Cooper Minis), and a soundtrack featuring everything from Lenny Kravitz to Jimi Hendrix, this highly anticipated title is finally ready to be driven.',
  //   meta_score: 95,
  //   user_review: 8.4,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PlayStation 2',
  //   release_date: '12-Aug-02',
  //   summary: "Take Your Game Online: Access an online community where you can meet, chat, and play head-to-head against other gamers. Audio Dream Team: Dynamic play-by-play and analysis by Madden and Michaels. All-New Mini-camp: Hop on John Madden's Cruiser Tour Bus and travel to all NFL cities to complete skilled tasks. Create-A-Playbook: Customize receiver routes, player formations, and your team's entire playbook. Deepest Franchise Mode Ever: Play 30 years of Franchise mode and draft players each season with tips from your scouts. [EA Sports]",
  //   meta_score: 95,
  //   user_review: 7.6,
  //   isEighthGen: false
  // },
  ...
  //   name: "Tony Hawk's Pro Skater 2",
  //   platform: 'Game Boy Advance',
  //   release_date: '30-May-01',
  //   summary: 'Hawks back, in the worlds first 3D handheld skating game, and hes brought new pros (Caballero, Koston, Mullen), New tricks (Bluntsides, BS/FS Nose-and Tailsides, Heelflip Varials, Airwalks, and more), and new terrain (Insane street and vert levels) Tony Hawks Pro Skater 2 for Game Boy Advance. Get your hands on a legend.',
  //   meta_score: 95,
  //   user_review: 6.9,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'Xbox One',
  //   release_date: '1-Sep-15',
  //   summary: "Following the prologue METAL GEAR SOLID V: GROUND ZEROES, METAL GEAR SOLID V: THE PHANTOM PAIN concludes the METAL GEAR SOLID V experience by following the story of the protagonist of the series, Big Boss (a.k.a. Snake). The METAL GEAR SOLID V experience is Creator and Director Hideo Kojima's first time incorporating open world gameplay to the groundbreaking METAL GEAR franchise.",
  //   meta_score: 95,
  //   user_review: 7.5,
  //   isEighthGen: true
  // },
  ...
  //   platform: 'PlayStation 3',
  //   release_date: '19-Apr-11',
  //   summary: 'Portal 2 is the sequel to the title named "Game of the Year" 2007 by over 30 publications around the world. Portal 2 promises to break new ground in next generation gaming by expanding the award-winning recipe of innovative gameplay, immersive story, and creative inclusion of music while also introducing multiplayer co-op game modes.',
  //   meta_score: 95,
  //   user_review: 8.7,
  //   isEighthGen: false
  // },
  ...
  //   name: 'God of War',
  //   platform: 'PlayStation 4',
  //   release_date: '20-Apr-18',
  //   summary: 'His vengeance against the gods of Olympus far behind him, Kratos now lives as a man in the lands of Norse Gods and monsters. It is in this harsh, unforgiving world that he must fight to survive?\x80? and teach his son to do the same. As mentor and protector to a son determined to earn his respect, Kratos is faced with an unexpected opportunity to master the rage that has long defined him. Questioning the dark lineage he?\x80?s passed on to his son, he hopes to make amends for the shortcomings of his past. Set within the untamed forests, mountains, and realms of Norse lore, God of War features a distinctly new setting with its own pantheon of creatures, monsters, and gods. [Playstation.com]',
  //   meta_score: 94,
  //   user_review: 9.2,
  //   isEighthGen: true
  // },
  ...
  //   platform: 'PlayStation 2',
  //   release_date: '23-Oct-02',
  //   summary: "Build your skills, earn respect, and show that you've got what it takes to Go Pro. 190 progressively harder goals. No time clock, no constraints. Pro-specific challenges. Evolving levels. Interact with other skaters. Multi-player modes. Customize your game...Your career is what you make of it. [Activision]",
  //   meta_score: 94,
  //   user_review: 8.4,
  //   isEighthGen: false
  // },
  ...
  //   name: 'Devil May Cry',
  //   platform: 'PlayStation 2',
  //   release_date: '16-Oct-01',
  //   summary: "In a large American metropolis, a man named Dante, a private investigator of the supernatural, is seeking revenge for the death of his mother and brother. The world is waiting, for Dante is no ordinary man, and with his father's sword in hand, he must enter the demon realm and avenge mankind. [Capcom]",
  //   meta_score: 94,
  //   user_review: 8.6,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PlayStation 2',
  //   release_date: '19-Aug-01',
  //   summary: "The industry football standard returns featuring the Houston Texans, new player face and body technology, the ability to create your own team with custom helmets, uniforms, and stadiums, and a new training mode that let's you learn from Madden, the master himself.",
  //   meta_score: 94,
  //   user_review: 7.3,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'PC',
  //   release_date: '29-Feb-96',
  //   summary: "An empire-building turn-based strategy game. The game starts at the Old Stone Age in 4000 BC. Your tribe begins with a Settlers unit and has no knowledge about the surrounding area. As you found new cities and explore the surroundings, you may find hostile barbarians, villages, and other competing cultures. [Civ Fantatics' Center]",
  //   meta_score: 94,
  //   user_review: 8.8,
  //   isEighthGen: false
  // },
  ...
  //   name: 'Quake',
  //   platform: 'PC',
  //   release_date: '22-Jun-96',
  //   summary: 'Rage through 32 single player levels and 6 deathmatch levels of sheer terror and fully immersive sound and lighting. Arm yourself against the cannibalistic Ogre, fiendish Vore and indestructible Schambler using letal nails, fierce Thunderbolts and abominable Rocket and Grenade Launchers. [id Software]',
  //   meta_score: 94,
  //   user_review: 8.8,
  //   isEighthGen: false
  // },
  ...
  //   platform: 'Dreamcast',
  //   release_date: '30-Oct-00',
  //   summary: 'Join a graffiti crew, stamp your territory and protect it from rival taggers, but watch out for the angry cops!',
  //   meta_score: 94,
  //   user_review: 8.3,
  //   isEighthGen: false
  // },
